puts """
NumberSolitaire: https://codility.com/demo/results/training6AUWBA-VSG/
...
def solution(a)
  d = 6
  n = a.size - 1
  max_score = Array.new(d, a[0])
  1.upto(n) do |c|
    max_score[c % d] = max_score.max + a[c]
  end
  max_score[n % d]
end

puts solution [1, -2, 0, 9, -1, -2] 
"""
...
puts "Result => #{solution [1, -2, 0, 9, -1, -2]}"