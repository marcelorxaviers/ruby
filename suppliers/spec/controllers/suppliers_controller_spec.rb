...
RSpec.describe SuppliersController, type: :controller do
  ...
  let(:valid_attributes) {
    { name: 'Marcelo', site: 'http://supplier.com', email: 'marcelo@supplier.com', phone: '+554888439879' }
  }
